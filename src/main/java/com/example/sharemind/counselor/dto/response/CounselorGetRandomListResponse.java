...
public class CounselorGetRandomListResponse extends CounselorGetListResponse {
    ...
    private CounselorGetRandomListResponse(Counselor counselor, Boolean isWishList, Boolean isRealtime,
                                           String sortType) {
        super(counselor, isWishList, isRealtime);
        this.sortType = sortType;
    }

    public static CounselorGetRandomListResponse of(Counselor counselor, Boolean isWishList, Boolean isRealtime,
                                                    String sortType) {
